...
// File @chainlink/contracts/src/v0.6/vendor/BufferChainlink.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/vendor/CBORChainlink.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/Chainlink.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/interfaces/ENSInterface.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/interfaces/ChainlinkRequestInterface.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/interfaces/PointerInterface.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/vendor/ENSResolver.sol@v0.1.6
...
// File @chainlink/contracts/src/v0.6/ChainlinkClient.sol@v0.1.6
...
// File @opengsn/gsn/contracts/interfaces/IRelayRecipient.sol@v2.1.0
...
// File @opengsn/gsn/contracts/BaseRelayRecipient.sol@v2.1.0
  ...
  view returns (bytes memory ret) {
    ...
    ********/
    ...
    function withdraw(uint256 amount) public returns (bool success) {
        ...
        _changeCommitterBalance(_msgSender(), amount, false);

        require(token.transfer(_msgSender(), amount), "SPC::withdraw - token transfer failed");
    ...
    function makeCommitment(
        ...
        commitments[_msgSender()] = commitment;

        emit NewCommitment(_msgSender(), activities[_activityKey].name, _goalValue, _startTime, _endTime, _stake);
    ...
    function processCommitmentUser() public {
        ...
        emit CommitmentEnded(_msgSender(), commitment.met, commitment.stake);
    }
    ...
    function _settleCommitment(Commitment storage commitment) internal returns (bool success) {
        ...
        commitment.met ? withdraw(commitment.stake) : _slashFunds(commitment.stake, _msgSender());
        return true;
    }
    ...
    /// @dev Based on add param add or substract amount from _msgSender balance and total committerBalance
    ...
    // Metatransactions
    function setTrustedForwarder(address _forwarder) public onlyOwner returns (bool) {
